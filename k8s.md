...
Kube-proxy
kube-proxy is the networking component running on each worker node. It handles Service networking and forwards traffic to the correct Pods.________________________________________
